...
import { BrowserConfig, ServiceOptions } from './types';
...
export class BrowsersContainerService {
  ...
  constructor(serviceOptions: ServiceOptions) {
    this.options = {
      pathToBrowsersConfig: `${root}/globals/web/services/browsers.json`,
  ...
  async pullRequiredBrowserFiles(): Promise<void> {
    try {
      ...
      const selenoidConfig: BrowserConfig = await require(this.selenoidBrowsersConfigPath);
