...
class CleverPage {
  ...
  get cleverLoginButton() {
    return $('//XCUIElementTypeButton[@name="Clever"]');
  }
  get districtInput() {
    return $('//XCUIElementTypeOther[@value="\n"]');
  }
  get districtSuggestion() {
    return $('//XCUIElementTypeOther[contains(@value,"Sandbox district")]');
  }
  get districtConfirmation() {
    return $('//XCUIElementTypeStaticText[@name="#DEMO Vizzle Prod Sandbox District"]');
  }
  get usernameField() {
  ...
  get cleverSubmitButton() {
    return $('(//XCUIElementTypeButton[@name="Log in"])[2]');
  }
  get sessionHistory() {
    return $('//XCUIElementTypeButton[@name="Session History"]');
  }
