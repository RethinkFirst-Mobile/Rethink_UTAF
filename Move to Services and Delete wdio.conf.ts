...
const ANDROID_APP = process.env.ANDROID_APP || path.join(process.cwd(), 'app/android/rethinked-v-25.1.1-(84)-debug 1.apk');
const IOS_APP = process.env.IOS_APP || '/Users/simonlopatin/Library/Developer/Xcode/DerivedData/iosApp-dzuuchkhwhfuvvfbhbybftveqmxc/Build/Products/Debug-iphonesimulator/iosApp.app';
...
if (provider === 'browserstack') {
    androidCaps['bstack:options'] = Object.assign({ projectName: process.env.BSTACK_PROJECT || 'Rethink' }, androidCaps['bstack:options'] || {});
    iosCaps['bstack:options'] = Object.assign({ projectName: process.env.BSTACK_PROJECT || 'Rethink' }, iosCaps['bstack:options'] || {});
}

if (provider === 'bitbar') {
    androidCaps['bitbar:options'] = Object.assign({ projectName: process.env.BITBAR_PROJECT || 'Rethink' }, androidCaps['bitbar:options'] || {});
    iosCaps['bitbar:options'] = Object.assign({ projectName: process.env.BITBAR_PROJECT || 'Rethink' }, iosCaps['bitbar:options'] || {});
}
